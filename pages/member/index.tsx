          ...
          <div className="content pt-50 pb-30 ps-30">
            ...
            <div className="menus">
              ...
              <div className="item mb-30">
                ...
                <p className="item-title m-0">
                  <a className="text-lg text-decoration-none">Messages</a>
                </p>
              </div>
              <div className="item mb-30">
                <svg className="icon me-3" width={25} height={25} viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p className="item-title m-0">
                  <a className="text-lg text-decoration-none">Card</a>
                </p>
              </div>
              <div className="item mb-30">
                <svg className="icon me-3" width={25} height={25} viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p className="item-title m-0">
                  <a className="text-lg text-decoration-none">Rewards</a>
                </p>
              </div>
              <div className="item mb-30">
                <svg className="icon me-3" width={25} height={25} viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
